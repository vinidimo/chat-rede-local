...
public class JanelaIP extends JFrame {
	...
	public JanelaIP(Observable c01) {
                ...
                this.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowClosing(java.awt.event.WindowEvent e) {  
                        if (e.getID() == WindowEvent.WINDOW_CLOSING) {  
                            int selectedOption = JOptionPane.showConfirmDialog(null,"Deseja encerrar Execuz�es?", "Sair",JOptionPane.YES_NO_OPTION);  
		...
		btnConfirma.addActionListener(new ActionListener() {
                ...
                getRootPane().setDefaultButton(btnConfirma); // Faz a tecla ENTER acionar o bot�o btnConfirma
		...
		public void confirma(){
                    ...
                    if(porta > 999 && porta < 99999){
                        ...
                        int selectedOption = JOptionPane.showConfirmDialog(null,"Confirma?", "Execuz�es", JOptionPane.YES_NO_OPTION);
                        if (selectedOption == JOptionPane.YES_OPTION) {
                            ...
                            setVisible(false); //janela de IPs fechar quando a do chat abrir
                                    ...
                                    JOptionPane.showMessageDialog(null, "Porta inv�lida!", "Erro!", 2);
                            }
                    }
                    catch (java.lang.NumberFormatException e) {
                            JOptionPane.showMessageDialog(null, "Valor inv�lido!", "Erro!", 2);
                    }
                }
